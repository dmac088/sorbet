...
public class PromotionMechanicViewDTO implements Serializable {
	...
	public PromotionMechanicViewDTO(Object[] tuple, Map<String, Integer> aliasToIndexMap) {
	...
	public PromotionMechanicViewDTO(Long mechanicId, String mechanicCode, String mechanicDesc, String locale) {
		super();
