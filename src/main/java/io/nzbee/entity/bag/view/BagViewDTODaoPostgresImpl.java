...
public class BagViewDTODaoPostgresImpl implements IBagViewDTODao {
	...
	private String getSQL() {
		...
		String sql = "WITH bag_items AS ( "
				...
				+ "  COALESCE(p.bag_item_bse_amt, 0) AS bag_item_bse_amt, "
				+ "  COALESCE(p.bag_item_dis_amt, 0) AS bag_item_dis_amt, "
				+ "  COALESCE(p.bag_item_tot_amt, 0) AS bag_item_tot_amt, "
				+ "  COALESCE(p.bag_item_tot_wgt, 0) AS bag_item_tot_wgt "
				+ "FROM  "
				+ "  mochi.party pty  "
				...
				+ "      bi.bag_item_bse_amt AS bag_item_bse_amt, "
				+ "      bi.bag_item_dis_amt AS bag_item_dis_amt, "
				+ "      bi.bag_item_tot_amt AS bag_item_tot_amt, "
				+ "      bi.bag_item_tot_wgt AS bag_item_tot_wgt "
				+ "    FROM  "
				+ "      bag_items bi  "
