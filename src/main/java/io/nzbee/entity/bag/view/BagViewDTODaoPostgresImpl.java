...
public class BagViewDTODaoPostgresImpl implements IBagViewDTODao {
	...
	private String getSQL() {
		...
		String sql = "WITH bag_items AS ( "
				...
				+ "  COALESCE(p.markdown_price, 0) as markdown_price,  "
				+ "  COALESCE(soh.soh_qty, 0) > 0 AS prd_in_stock,  "
				+ "  p.bag_item_typ_cd,  "
				+ "  COALESCE(p.bag_item_dis_pctg, 0) AS bag_item_dis_pctg, "
				...
				+ "      bi.bag_item_dis_pctg AS bag_item_dis_pctg, "
