...
public class DepartmentDomainDTO implements Serializable {
	...
	public DepartmentDomainDTO(Object[] tuple, Map<String, Integer> aliasToIndexMap) {
	...
	public DepartmentDomainDTO(Long departmentId, String departmentCode, String departmentDesc, String locale) {
