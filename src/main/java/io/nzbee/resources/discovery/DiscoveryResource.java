...
public class DiscoveryResource extends RepresentationModel<DiscoveryResource> {
	...
	public DiscoveryResource() {
		...
		this.add(linkTo(methodOn(CategoryController.class).getProductCategories(null)).withRel("getAllCategories"));
		this.add(linkTo(methodOn(CustomerController.class).getCustomer(null)).withRel("getCustomer"));
		this.add(linkTo(methodOn(CustomerController.class).registerNewCustomer(null, null, null, null)).withRel("registerCustomer"));
		...
		this.add(linkTo(methodOn(ProductController.class).getShippingProviders(null, null)).withRel("getShippingProviders"));
		this.add(linkTo(methodOn(ProductController.class).getShippingDestinations(null)).withRel("getShippingDestinations"));
		this.add(linkTo(methodOn(ProductController.class).getByDestinationAndType(null, null, null, null, null)).withRel("getShippingProduct"));
